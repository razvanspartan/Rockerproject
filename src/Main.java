...
public class Main {
    public static void main(String[] args) {
        ...
        parserForPlanets.parseFileSolarSystem("/home/razvanspartan/IdeaProjects/Rocketproject/src/data/input/Solar_System_Data.txt", planetData);
        ...
        System.out.println(service.convertRadiansToDegrees(earth.getAngularPosition(BigDecimal.valueOf(100))));
        System.out.println(service.closestTimeToAlignAfterSomeTime(earth,mars,BigDecimal.valueOf(100)).divide(DAYS_IN_A_YEAR, MathContext.DECIMAL128).setScale(1,RoundingMode.HALF_UP));
